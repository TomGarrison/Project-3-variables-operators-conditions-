...
var number1= 20, number2= 10;
var number3= number1 * number2;
document.getElementById("q4a").innerHTML= number3;
...
var dog= "Black Lab";
var cat= "Black Cat BOOOO";
var catDog= dog + "" + cat;
document.getElementById("q5").innerHTML = catDog;
...
var strings= '5';
var strings2= '3';
var stringsTest= strings + strings2;
document.getElementById("q6a").innerHTML= strings;
document.getElementById('q6b').innerHTML= strings2;
document.getElementById('q6c').innerHTML= stringsTest;
document.getElementById('q6note').innerHTML= "I added var strings/strings2 to create a string called strings3. Using the math operator +. With the display being 53. Not adding the string as if the where a number value. The program simply does what im asking it to do. With is add string1 to the backend of string2 to make a var stringsTest.";
...
document.getElementById('q7').innerHTML= "It Worked"
});
...
if (score > 90){
  ...
  document.getElementById('q10').innerHTML= "Nice Work, Keep pracicing"
  }

else {
  document.getElementById('q10').innerHTML= "Very Bad: Study more and retke the test"
};
